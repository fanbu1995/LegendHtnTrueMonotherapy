...
OhdsiRTools::checkUsagePackage("LEGENDHTNTrueMonotherapy")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/LEGENDHTNTrueMonotherapy.pdf")
shell("R CMD Rd2pdf ./ --output=extras/LEGENDHTNTrueMonotherapy.pdf")
...
ROhdsiWebApi::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                 ...
                                                 generateStats = FALSE,
                                                 packageName = "LEGENDHTNTrueMonotherapy")
...
OhdsiRTools::createRenvLockFile("LEGENDHTNTrueMonotherapy")
